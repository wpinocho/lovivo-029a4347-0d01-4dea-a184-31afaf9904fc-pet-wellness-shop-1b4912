...
export const EcommerceTemplate = ({
  ...
  const footer = (
    <div className={`bg-muted/30 py-12 border-t ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Links */}
          <div>
            <h3 className="font-medium mb-4 text-foreground">Links</h3>
          ...
          {/* Social Links */}
          <div>
            <h3 className="font-medium mb-4 text-foreground">Follow Us</h3>
            <SocialLinks />
          </div>
        </div>

        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>&copy; 2025 Pet Wellness. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
